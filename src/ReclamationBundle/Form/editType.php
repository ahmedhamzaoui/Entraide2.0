...
class editType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('description', CKEditorType::class)
            ...
            ->add('lieuDecouverte', ChoiceType::class, array('choices'=>array(''=>'','esprit ghazela'=>'esprit ghazela','esprit charguia'=>'esprit charguia')))
            ...
            ->add('salle')
            ->add('photo',FileType::class ,array('label'=>'Image','data_class'=>null))
